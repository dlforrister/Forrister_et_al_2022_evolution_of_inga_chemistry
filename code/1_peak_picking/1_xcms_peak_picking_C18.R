...
### Define absolute path to mzxml files, ending with folder containing subsequent folders named by site ###
mzxml_location <- "K:/Lab_Map/git_repositories/Evolution_Of_Inga_Chemistry-master/mzxml_paths/C18/"

# set retention time cutoffs (in minutes) for peaks that should be kept in analysis (after 1 minute and before 32 minutes
# for C18 column standard runs)
min_rt <- 1
max_rt <- 32
...
for(j in 1:length(species)) {
  ...
  # ex. "IngA_1619"
  processed_sample <- unique(dbGetQuery(mydb, "SELECT Species_code_sample FROM `XCMS_DB`"))[,"Species_code_sample"]
  ...
  # binSize = mz used for profile matrix generation
  
  oparam <- ObiwarpParam(binSize=1)
  
  ## second round of peak grouping with more stringent parameters
  ...
  # Clean up peak list by deleting internal standard, other known contaminants, and peaks found in blanks
  # Delete rows found in blank and rows where ratio of blank to sample is greater than 0.33
  xset5[is.na(xset5)] <- 0
  
  # calculate average value of each peak in the blank/blanks
  ...
  xset6 <- xset5[xset5$TIC_ratio < 0.33, ]
  
  ## remove biochanin, mz=91.008, alkyl benzene sulfonate surfactant
  # biochanin
  ...
  if(nrow(xset6[which(abs(xset6$rt - 1534) <= 50 & abs(xset6$mz-339.199) <=0.1),]) >0) {xset6 <- xset6[-which(abs(xset6$rt - 1534) <= 50 & abs(xset6$mz-339.19) <=0.1),]}
  if(nrow(xset6[which(abs(xset6$rt - 1590) <= 50 & abs(xset6$mz-248.08) <=0.1),]) >0) {xset6 <- xset6[-which(abs(xset6$rt - 1590) <= 50 & abs(xset6$mz-248.08) <=0.1),]}
  if(nrow(xset6[which(abs(xset6$rt - 1621) <= 50 & abs(xset6$mz-339.199) <=0.1),]) >0) {xset6 <- xset6[-which(abs(xset6$rt - 1621) <= 50 & abs(xset6$mz-339.19) <=0.1),]}
  if(nrow(xset6[which(abs(xset6$rt - 1690) <= 50 & abs(xset6$mz-339.199) <=0.1),]) >0) {xset6 <- xset6[-which(abs(xset6$rt - 1690) <= 50 & abs(xset6$mz-339.19) <=0.1),]}
  if(nrow(xset6[which(abs(xset6$rt - 1755) <= 50 & abs(xset6$mz-297.15) <=0.1),]) >0) {xset6 <- xset6[-which(abs(xset6$rt - 1755) <= 50 & abs(xset6$mz-297.15) <=0.1),]}
  if(nrow(xset6[which(abs(xset6$rt - 1775) <= 50 & abs(xset6$mz-297.15) <=0.1),]) >0) {xset6 <- xset6[-which(abs(xset6$rt - 1775) <= 50 & abs(xset6$mz-297.15) <=0.1),]}
  if(nrow(xset6[which(abs(xset6$rt - 1810) <= 50 & abs(xset6$mz-297.15) <=0.1),]) >0) {xset6 <- xset6[-which(abs(xset6$rt - 1810) <= 50 & abs(xset6$mz-297.15) <=0.1),]}
  if(nrow(xset6[which(abs(xset6$rt - 1775) <= 50 & abs(xset6$mz-311.168) <=0.1),]) >0) {xset6 <- xset6[-which(abs(xset6$rt - 1775) <= 50 & abs(xset6$mz-311.168) <=0.1),]}
  if(nrow(xset6[which(abs(xset6$rt - 1842) <= 50 & abs(xset6$mz-311.168) <=0.1),]) >0) {xset6 <- xset6[-which(abs(xset6$rt - 1842) <= 50 & abs(xset6$mz-311.168) <=0.1),]}
  if(nrow(xset6[which(abs(xset6$rt - 1865) <= 50 & abs(xset6$mz-311.168) <=0.1),]) >0) {xset6 <- xset6[-which(abs(xset6$rt - 1865) <= 50 & abs(xset6$mz-311.168) <=0.1),]}
  if(nrow(xset6[which(abs(xset6$rt - 1900) <= 50 & abs(xset6$mz-311.168) <=0.1),]) >0) {xset6 <- xset6[-which(abs(xset6$rt - 1900) <= 50 & abs(xset6$mz-311.168) <=0.1),]}
  if(nrow(xset6[which(abs(xset6$rt - 1950) <= 50 & abs(xset6$mz-311.168) <=0.1),]) >0) {xset6 <- xset6[-which(abs(xset6$rt - 1950) <= 50 & abs(xset6$mz-311.168) <=0.1),]}
  if(nrow(xset6[which(abs(xset6$rt - 940) <= 50 & abs(xset6$mz-236.0959) <=0.1),]) >0) {xset6 <- xset6[-which(abs(xset6$rt - 940) <= 50 & abs(xset6$mz-236.0959) <=0.1),]}
  if(nrow(xset6[which(abs(xset6$rt - 1010) <= 50 & abs(xset6$mz-255.0693) <=0.1),]) >0) {xset6 <- xset6[-which(abs(xset6$rt - 1010) <= 50 & abs(xset6$mz-255.0693) <=0.1),]}
  if(nrow(xset6[which(abs(xset6$rt - 1180) <= 50 & abs(xset6$mz-269.0856) <=0.1),]) >0) {xset6 <- xset6[-which(abs(xset6$rt - 1180) <= 50 & abs(xset6$mz-269.0856) <=0.1),]}
  if(nrow(xset6[which(abs(xset6$rt - 1200) <= 50 & abs(xset6$mz-329.233) <=0.1),]) >0) {xset6 <- xset6[-which(abs(xset6$rt - 1200) <= 50 & abs(xset6$mz-329.233) <=0.1),]}
  if(nrow(xset6[which(abs(xset6$rt - 1285) <= 50 & abs(xset6$mz-329.233) <=0.1),]) >0) {xset6 <- xset6[-which(abs(xset6$rt - 1285) <= 50 & abs(xset6$mz-329.233) <=0.1),]}
  if(nrow(xset6[which(abs(xset6$rt - 1350) <= 50 & abs(xset6$mz-329.233) <=0.1),]) >0) {xset6 <- xset6[-which(abs(xset6$rt - 1350) <= 50 & abs(xset6$mz-329.233) <=0.1),]}
  if(nrow(xset6[which(abs(xset6$rt - 1440) <= 50 & abs(xset6$mz-329.233) <=0.1),]) >0) {xset6 <- xset6[-which(abs(xset6$rt - 1440) <= 50 & abs(xset6$mz-329.233) <=0.1),]}
  if(nrow(xset6[which(abs(xset6$rt - 1500) <= 50 & abs(xset6$mz-327.163) <=0.1),]) >0) {xset6 <- xset6[-which(abs(xset6$rt - 1500) <= 50 & abs(xset6$mz-327.163) <=0.1),]}
  if(nrow(xset6[which(abs(xset6$rt - 1530) <= 50 & abs(xset6$mz-329.233) <=0.1),]) >0) {xset6 <- xset6[-which(abs(xset6$rt - 1530) <= 50 & abs(xset6$mz-329.233) <=0.1),]}
  if(nrow(xset6[which(abs(xset6$rt - 1580) <= 50 & abs(xset6$mz-313.239) <=0.1),]) >0) {xset6 <- xset6[-which(abs(xset6$rt - 1580) <= 50 & abs(xset6$mz-313.239) <=0.1),]}
  if(nrow(xset6[which(abs(xset6$rt - 1675) <= 50 & abs(xset6$mz-313.239) <=0.1),]) >0) {xset6 <- xset6[-which(abs(xset6$rt - 1675) <= 50 & abs(xset6$mz-313.239) <=0.1),]}
  if(nrow(xset6[which(abs(xset6$rt - 1680) <= 50 & abs(xset6$mz-277.144) <=0.1),]) >0) {xset6 <- xset6[-which(abs(xset6$rt - 1680) <= 50 & abs(xset6$mz-277.144) <=0.1),]}
  if(nrow(xset6[which(abs(xset6$rt - 1950) <= 50 & abs(xset6$mz-325.183) <=0.1),]) >0) {xset6 <- xset6[-which(abs(xset6$rt - 1950) <= 50 & abs(xset6$mz-325.183) <=0.1),]}
  ## mz=91.008
  ...
  dbWriteTable(mydb, 'xcms_feature_table_long', feature_table_long , field.types = fields, row.names = F, overwrite = FALSE, append = T)
}
}
