...
write.csv(similarity_matrix_sap,"/uufs/chpc.utah.edu/common/home/inga-group1/Figures_Evol_Inga_Chemistry/Evolving_Samples/real_samples/allcomps_species_saponin_similarity_2020_12_13.csv",row.names=T)
...
write.csv(similarity_matrix_phen,"/uufs/chpc.utah.edu/common/home/inga-group1/Figures_Evol_Inga_Chemistry/Evolving_Samples/real_samples/allcomps_species_phenolic_similarity_2020_12_13.csv",row.names=T)
...
write.csv(pairwise.spp, "/uufs/chpc.utah.edu/common/home/inga-group1/Figures_Evol_Inga_Chemistry/Evolving_Samples/real_samples/allcomps_species_similarity_2020_12_13.csv", row.names = TRUE)
